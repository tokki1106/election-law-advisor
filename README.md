<p align="center">
  <img src="docs/images/icon.png" alt="선거법 AI 상담" width="200">
</p>

<h1 align="center">선거법 자문 에이전트</h1>

<p align="center">
  한국 선거법(공직선거법, 정치자금법, 정당법)에 기반하여<br>
  특정 행위가 선거법에 저촉되는지 판단하고 조언하는 <strong>대화형 웹서비스</strong>입니다.
</p>

<p align="center">
  두 명의 AI 에이전트(보수적/관용적)가 <strong>실시간으로 동시에 토론</strong>하고,<br>
  합의를 도출하여 위험도 등급과 함께 답변합니다.
</p>
